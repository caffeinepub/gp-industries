...
const LocationCtx = reactExports.createContext({ pathname: "/" });
const NavigateCtx = reactExports.createContext(
  () => {
  }
);
function BrowserRouter({ children }) {
  ...
  const navigate = reactExports.useCallback((to, replace) => {
    if (replace) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LocationCtx.Provider, { value: { pathname }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavigateCtx.Provider, { value: navigate, children }) });
}
function useLocation() {
  return reactExports.useContext(LocationCtx);
}
function useNavigate() {
  return reactExports.useContext(NavigateCtx);
}
function Link({
  to,
  children,
...
function Routes({ children }) {
  ...
  React$2.Children.forEach(children, (child) => {
    if (React$2.isValidElement(child) && child.props) {
      const props = child.props;
      routes.push({ path: props.path, element: props.element });
    }
  });
  const exact = routes.find((r) => r.path === pathname);
  if (exact) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: exact.element });
  const wildcard = routes.find((r) => r.path === "*");
  if (wildcard) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: wildcard.element });
  return null;
}
function Navigate({ to, replace }) {
  const navigate = reactExports.useContext(NavigateCtx);
...
const storage = {
  ...
  setAdmin: (admin) => localStorage.setItem("gpAdmin", JSON.stringify(admin)),
  getAdminSecretKey: () => {
    return localStorage.getItem("gpAdminSecretKey");
  },
  setAdminSecretKey: (key) => localStorage.setItem("gpAdminSecretKey", key),
  getSecretKeyHint: () => {
    return localStorage.getItem("gpSecretKeyHint");
  },
  setSecretKeyHint: (hint) => localStorage.setItem("gpSecretKeyHint", hint),
  getEmployees: () => {
    const d = localStorage.getItem("gpEmployees");
    return d ? JSON.parse(d) : [];
  },
  setEmployees: (emps) => localStorage.setItem("gpEmployees", JSON.stringify(emps)),
  getCurrentUser: () => {
  ...
  setAttendance: (a) => localStorage.setItem("gpAttendance", JSON.stringify(a)),
  getSalary: () => {
    const d = localStorage.getItem("gpSalary");
    return d ? JSON.parse(d) : [];
  },
  setSalary: (s) => localStorage.setItem("gpSalary", JSON.stringify(s)),
  getContracts: () => {
    const d = localStorage.getItem("gpContracts");
    return d ? JSON.parse(d) : [];
  },
  setContracts: (c) => localStorage.setItem("gpContracts", JSON.stringify(c)),
  getProfitLoss: () => {
    const d = localStorage.getItem("gpProfitLoss");
    return d ? JSON.parse(d) : { income: [], expenses: [] };
  },
  setProfitLoss: (pl) => localStorage.setItem("gpProfitLoss", JSON.stringify(pl))
};
...
function generateId(prefix2, existing) {
  let n = existing.length + 1;
  let id = `${prefix2}${String(n).padStart(3, "0")}`;
  while (existing.includes(id)) {
    n++;
    id = `${prefix2}${String(n).padStart(3, "0")}`;
  }
  return id;
}
const MONTHS = [
...
const navItems = [
  ...
  { path: "/analysis", label: "Analysis", icon: ChartNoAxesColumn }
];
function Sidebar({ isOpen = false, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `flex flex-col w-64 min-h-screen fixed left-0 top-0 z-30 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0`,
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-5 border-b border-white/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-bold text-sm", children: "GP INDUSTRIES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-blue-300 text-xs", children: "Management System" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-white/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ((_a2 = user == null ? void 0 : user.name) == null ? void 0 : _a2.charAt(0).toUpperCase()) || "U"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-xs font-semibold truncate", children: (user == null ? void 0 : user.name) || "User" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-blue-300 text-xs capitalize", children: (user == null ? void 0 : user.role) || "employee" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 py-4 overflow-y-auto", children: [
          navItems.map(({ path, label, icon: Icon2 }) => {
            const active = location2.pathname === path;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: path,
                ...
                className: `flex items-center gap-3 px-6 py-3 mx-2 rounded-lg mb-1 text-sm transition-all ${active ? "bg-white/15 text-white font-semibold" : "text-blue-200 hover:bg-white/10 hover:text-white"}`,
                children: [
          ...
          (user == null ? void 0 : user.role) === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              className: `flex items-center gap-3 px-6 py-3 mx-2 rounded-lg mb-1 text-sm transition-all ${location2.pathname === "/change-secret-key" ? "bg-white/15 text-white font-semibold" : "text-blue-200 hover:bg-white/10 hover:text-white"}`,
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 border-t border-white/10 space-y-1", children: [
          (user == null ? void 0 : user.role) === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-4 flex items-center gap-2 text-blue-400 text-xs", children: [
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen", style: { background: "#F4F6F9" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { isOpen: open, onClose: () => setOpen(false) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 md:ml-64 flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 shadow-sm sticky top-0 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 22, className: "text-gray-700" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-900 text-sm", children: "GP INDUSTRIES" })
        ] }),
...
function Analysis() {
  ...
  const years = [];
  for (let y = START_YEAR; y <= currentYear2 + 1; y++) years.push(y);
  const [selectedYear, setSelectedYear] = reactExports.useState(currentYear2);
  const attendanceByMonth = MONTHS.map((_, mi) => {
    ...
    const presentCount = Object.entries(attendance).filter(([k, v]) => {
      const parts = k.split("-");
      return Number.parseInt(parts[0]) === selectedYear && Number.parseInt(parts[1]) === m && v === "P";
    }).length;
    return totalSlots > 0 ? Math.round(presentCount / totalSlots * 100) : 0;
  });
  const salaryByMonth = MONTHS.map((_, mi) => {
    const m = mi + 1;
    return salary.filter((s) => s.month === m && s.year === selectedYear).reduce((sum, s) => sum + s.netPay, 0);
  });
  ...
  const plByMonth = MONTHS.map((_, mi) => {
    const m = mi + 1;
    const income = pl.income.filter((i) => {
      const d = new Date(i.date);
      return d.getMonth() + 1 === m && d.getFullYear() === selectedYear;
    }).reduce((s, i) => s + i.amount, 0);
    const expense = pl.expenses.filter((e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Analysis & Insights" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "label",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: years.map((y) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: y, children: [
              y,
              y === currentYear2 ? " (Current)" : y === currentYear2 + 1 ? " (Next)" : ""
            ] }, y))
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-400 font-semibold uppercase mb-1", children: s.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-bold text-gray-800 mb-4", children: [
          "Attendance Rate by Month (",
          selectedYear,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1 md:gap-2 h-32", children: MONTHS.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-500 font-medium hidden sm:block", children: [
            attendanceByMonth[i],
            "%"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                background: attendanceByMonth[i] >= 80 ? "#18B6B2" : attendanceByMonth[i] >= 60 ? "#2F6FEA" : "#EA8C2F",
                minHeight: 4
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: m.slice(0, 3) })
        ] }, m)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: MONTHS.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 w-8", children: m.slice(0, 3) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-gray-100 rounded-full h-4 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-gray-700 w-20 md:w-24 text-right", children: [
              "RM ",
              salaryByMonth[i].toLocaleString()
            ] })
          ] }, m)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 mb-4", children: "Contract Summary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-3 bg-teal-50 rounded-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-teal-600 font-semibold", children: "CONTRACT IN (Client)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg font-bold text-teal-700", children: [
                  inContracts.length,
                  " contracts"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-400", children: "Total Value" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-teal-700", children: [
                  "RM ",
                  inValue.toLocaleString()
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-3 bg-orange-50 rounded-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-orange-600 font-semibold", children: "CONTRACT OUT (Vendor)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg font-bold text-orange-700", children: [
                  outContracts.length,
                  " contracts"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-400", children: "Total Value" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-orange-700", children: [
                  "RM ",
                  outValue.toLocaleString()
                ] })
              ] })
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#F4F6F9" }, children: [
            "Month",
            "Income (RM)",
            "Expenses (RM)",
            "Net (RM)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: MONTHS.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-gray-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-gray-700 font-medium", children: m }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-green-600", children: plByMonth[i].income.toLocaleString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-red-500", children: plByMonth[i].expense.toLocaleString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "td",
              {
                className: `px-4 py-2 font-bold ${plByMonth[i].net >= 0 ? "text-green-600" : "text-red-500"}`,
                children: plByMonth[i].net.toLocaleString()
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2", children: plByMonth[i].income > 0 || plByMonth[i].expense > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: plByMonth[i].net >= 0 ? "Profit" : "Loss"
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-300", children: "No data" }) })
          ] }, m)) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
        ...
        ].map((insight, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
...
function DownloadButton() {
  ...
  function dlSalary() {
    ...
    for (const s of sal) {
      ...
      rows.push([
        s.empId,
        (emp == null ? void 0 : emp.name) || "",
        (emp == null ? void 0 : emp.jobTitle) || "",
        MONTHS[s.month - 1],
        String(s.year),
        String(s.basicPay),
        String(s.allowances),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 z-20 overflow-hidden", children: menuItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: item.action,
...
function Attendance() {
  ...
  const today = /* @__PURE__ */ new Date();
  const [month, setMonth] = reactExports.useState(today.getMonth() + 1);
  const [year, setYear] = reactExports.useState(today.getFullYear());
  const [attendance, setAttendance] = reactExports.useState(storage.getAttendance());
  const employees = storage.getEmployees().filter((e) => e.status === "active");
  const displayEmps = isAdmin ? employees : employees.filter((e) => e.empId === (user == null ? void 0 : user.empId));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Attendance" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8", children: [
      isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-blue-600 bg-blue-50 px-4 py-2 rounded-lg mb-4", children: "Admin: Click any cell to toggle attendance between P (Present) and A (Absent)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "text-xs min-w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#F4F6F9" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 text-left font-semibold text-gray-600 sticky left-0 bg-gray-50 z-10", children: "Emp ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 text-left font-semibold text-gray-600 sticky left-16 bg-gray-50 z-10", children: "Name" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 text-center font-semibold text-green-600", children: "P" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 text-center font-semibold text-red-500", children: "A" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: displayEmps.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "td",
          {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 font-mono text-blue-600 sticky left-0 bg-white z-10", children: emp.empId }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 font-medium text-gray-700 sticky left-16 bg-white z-10 whitespace-nowrap", children: emp.name }),
                days.map((d) => {
                  const val = getVal(emp.empId, d);
                  return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-1 py-2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => toggle(emp.empId, d),
                      disabled: !isAdmin,
                      className: `w-7 h-7 rounded text-xs font-bold transition-all ${val === "P" ? "bg-green-100 text-green-700 hover:bg-green-200" : "bg-red-100 text-red-600 hover:bg-red-200"} ${!isAdmin ? "cursor-default" : "cursor-pointer"}`,
                      children: val
                    }
                  ) }, d);
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-center font-bold text-green-600", children: totalP }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-center font-bold text-red-500", children: totalA })
              ]
            },
            emp.empId
          );
...
function ChangeSecretKey() {
  ...
  const [currentKey, setCurrentKey] = reactExports.useState("");
  const [newKey, setNewKey] = reactExports.useState("");
  const [newHint, setNewHint] = reactExports.useState("");
  ...
  if (!user || user.role !== "admin") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #0B1F33 0%, #0A2B4A 60%, #0d3561 100%)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl text-center max-w-sm w-full mx-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 font-semibold", children: "Access denied. Admin only." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/dashboard",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { background: "linear-gradient(135deg, #2F6FEA, #18B6B2)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { size: 28, className: "text-white" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold", children: "GP INDUSTRIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm mt-1", children: "Change Admin Secret Key" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl", children: [
          success ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4",
                style: { background: "#e6f9f0" },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 text-2xl", children: "✓" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-2", children: "Secret Key Updated" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Your new secret key is now active. Keep it safe!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-1", children: "Verify Identity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-5", children: "Enter your current secret key to continue. You can change it as many times as needed." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleVerify, className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Current Secret Key" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
              ...
              error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm bg-red-50 px-3 py-2 rounded-lg", children: error }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "submit",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-1", children: "Set New Secret Key" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-5", children: "Choose a new secret key. You can also update the hint shown on the login page." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleChange, className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: "New Secret Key" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: [
                  "New Hint",
                  " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "Update Secret Key"
                }
              )
            ] })
          ] }),
          !success && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-gray-500 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/dashboard",
...
function Contracts() {
  ...
  function save() {
    let updated;
    if (editId) {
      updated = contracts.map(
        (c) => c.id === editId ? { ...c, ...form, value: Number.parseFloat(form.value) || 0 } : c
      );
    } else {
      const newC = {
        id: generateId(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Contracts" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "IN", children: "IN (Client)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "OUT", children: "OUT (Vendor)" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 md:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#F4F6F9" }, children: [
        "ID",
        "Title",
        "Type",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: display.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          colSpan: isAdmin ? 9 : 8,
          className: "px-4 py-8 text-center text-gray-400",
      ...
      ) }) : display.map((c, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          "data-ocid": `contracts.item.${idx + 1}`,
          className: "border-t border-gray-50 hover:bg-gray-50",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-blue-600 text-xs whitespace-nowrap", children: c.id }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-gray-800", children: c.title }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-600 whitespace-nowrap", children: c.clientVendor }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-semibold text-gray-800 whitespace-nowrap", children: c.value.toLocaleString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-500 whitespace-nowrap", children: c.startDate }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-500 whitespace-nowrap", children: c.endDate }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
    ...
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: editId ? "Edit Contract" : "Add Contract" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: f.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: "Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    value: form.type,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: "Status" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    value: form.status,
    ...
    deleteConfirm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900 mb-2", children: "Delete Contract" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mb-5", children: "Are you sure you want to delete this contract? This cannot be undone." }),
...
function Dashboard() {
  ...
  const currentYear2 = today.getFullYear();
  const monthlySalary = salary.filter((s) => s.month === currentMonth && s.year === currentYear2).reduce((sum, s) => sum + s.netPay, 0);
  const activeContracts = contracts.filter((c) => c.status === "active").length;
  const monthIncome = pl.income.filter((i) => {
    const d = new Date(i.date);
    return d.getMonth() + 1 === currentMonth && d.getFullYear() === currentYear2;
  }).reduce((sum, i) => sum + i.amount, 0);
  const monthExpense = pl.expenses.filter((e) => {
    const d = new Date(e.date);
    return d.getMonth() + 1 === currentMonth && d.getFullYear() === currentYear2;
  ...
  const cards = [
    ...
    },
    {
      ...
      sub: `${today.toLocaleString("default", { month: "long" })} ${currentYear2}`,
      icon: DollarSign,
      color: "#7C3AED",
      bg: "#F3EEFF",
      path: "/salary"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "GP Industries Overview" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500 hidden sm:block", children: today.toLocaleDateString("en-MY", {
          weekday: "long",
          year: "numeric",
          month: "long",
          day: "numeric"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6", children: cards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(card.icon, { size: 22, style: { color: card.color } })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-900 mb-1", children: card.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-gray-700 mb-1", children: card.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-400", children: card.sub })
          ]
        },
        card.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 text-center text-xs text-gray-400 py-4 border-t border-gray-100", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
...
function Employees() {
  ...
  const [editingEmpId, setEditingEmpId] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Employee Details" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 md:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#F4F6F9" }, children: headers.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "th",
        {
      ...
      ) }) : displayEmps.map((emp, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          "data-ocid": `employees.item.${idx + 1}`,
          className: "border-t border-gray-50 hover:bg-gray-50 transition-colors",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-blue-600 font-semibold whitespace-nowrap", children: emp.empId }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-gray-800 whitespace-nowrap", children: emp.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-600", children: emp.username }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-gray-700", children: emp.password }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-600 whitespace-nowrap", children: emp.jobTitle }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: `inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${emp.status === "active" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`,
                children: [
                  emp.status === "active" ? /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 11 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(UserX, { size: 11 }),
                  emp.status
                ]
              }
            ) }),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  type: "button",
                  onClick: () => deleteEmployee(emp.empId, emp.name),
    ...
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900", children: modalMode === "add" ? "Add New Employee" : "Edit Employee" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            modalMode === "add" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: "Employee ID (Auto-generated)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  value: newEmpId,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 mt-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: { background: "#2F6FEA" },
                children: modalMode === "add" ? "Save Employee" : "Update Employee"
              }
            )
          ] })
        ]
...
function Login() {
  ...
  function handleLogin(e) {
    ...
    const emps = storage.getEmployees();
    const emp = emps.find(
      (e2) => (e2.username === username || e2.empId === username) && e2.password === password
    );
    if (emp) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4",
              style: { background: "linear-gradient(135deg, #2F6FEA, #18B6B2)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xl", children: "GP" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold", children: "GP INDUSTRIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm mt-1", children: "Business Management System" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-1", children: "Welcome Back" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Sign in with your Employee ID or Admin credentials" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Username / Employee ID" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Password" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Lock,
                  {
          ...
          secretKeyHint && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 px-3 py-2 bg-blue-50 border border-blue-100 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-blue-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Secret Key Hint:" }),
            " ",
            secretKeyHint
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm text-gray-500 mt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/register",
                className: "text-blue-600 font-medium hover:underline",
                children: "Register / Reset Admin"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 text-blue-400 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 12 }),
...
function ProfitLoss() {
  ...
  const [month, setMonth] = reactExports.useState(today.getMonth() + 1);
  const [year, setYear] = reactExports.useState(today.getFullYear());
  const [data, setData] = reactExports.useState(storage.getProfitLoss());
  const [showModal, setShowModal] = reactExports.useState(false);
  const [entryType, setEntryType] = reactExports.useState("income");
  const [editId, setEditId] = reactExports.useState(null);
  ...
  function filterByMonth(entries) {
  ...
  function save() {
    ...
    if (editId) {
      updated = {
        income: entryType === "income" ? data.income.map((e) => e.id === editId ? entry : e) : data.income,
        expenses: entryType === "expense" ? data.expenses.map((e) => e.id === editId ? entry : e) : data.expenses
      };
    } else {
      updated = entryType === "income" ? { ...data, income: [...data.income, entry] } : { ...data, expenses: [...data.expenses, entry] };
    }
  ...
  function doDelete() {
    ...
    const updated = {
      income: type === "income" ? data.income.filter((e) => e.id !== id) : data.income,
      expenses: type === "expense" ? data.expenses.filter((e) => e.id !== id) : data.expenses
    };
    storage.setProfitLoss(updated);
    setData(updated);
    setDeleteConfirm(null);
  ...
  function EntryTable({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800", style: { color }, children: title }),
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          "tr",
          {
            className: "border-t border-gray-50 hover:bg-gray-50",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-500 text-xs whitespace-nowrap", children: e.date }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600 text-xs", children: e.category }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-700", children: e.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "td",
                {
              ...
              isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Profit & Loss" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 font-semibold uppercase mb-2", children: s.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold", style: { color: s.color }, children: [
              "RM ",
    ...
    deleteConfirm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900 mb-2", children: "Delete Entry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mb-5", children: "Are you sure you want to delete this entry? This cannot be undone." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold", children: "GP INDUSTRIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm mt-1", children: isFirstTime ? "Admin Setup - First Time Registration" : "Reset Admin Account" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-1", children: isFirstTime ? "Create Admin Account" : "Reset Admin Account" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: isFirstTime ? "Set up the administrator account. You may optionally set a secret key to protect future registrations." : "Enter the admin secret key to verify your identity before resetting." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
            ...
            ].map(({ field, label, type }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-100 pt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: [
                ...
                isFirstTime && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-normal ml-1", children: "(optional)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mb-2", children: isFirstTime ? "Optional: Set a secret key to protect future registrations. Leave blank to skip." : "Enter the secret key to confirm you are authorized to reset this account." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
                  ...
                  placeholder: isFirstTime ? "Create a secret key (optional)" : "Enter the secret key",
                  className: "w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500",
                  required: needsSecretVerify
                }
              )
            ] }),
            isFirstTime && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block text-sm font-medium text-gray-700 mb-1", children: [
                "Secret Key Hint",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 font-normal", children: "(optional)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mb-2", children: 'A hint shown on the login page to remind you of your key -- without revealing it. E.g. "my first car"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
                  value: form.secretKeyHint,
                  onChange: (e) => setForm({ ...form, secretKeyHint: e.target.value }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isFirstTime ? "Create Admin Account" : "Reset Admin Account"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-gray-500 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/login",
              className: "text-blue-600 font-medium hover:underline",
...
function Salary() {
  ...
  const [month, setMonth] = reactExports.useState(today.getMonth() + 1);
  const [year, setYear] = reactExports.useState(today.getFullYear());
  const [records, setRecords] = reactExports.useState(storage.getSalary());
  const [showModal, setShowModal] = reactExports.useState(false);
  const [editId, setEditId] = reactExports.useState(null);
  const [form, setForm] = reactExports.useState({
    empId: "",
  ...
  const display = isAdmin ? filtered : filtered.filter((r) => r.empId === (user == null ? void 0 : user.empId));
  function openAdd() {
    setEditId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 px-4 py-4 md:px-8 md:py-5 bg-white border-b border-gray-100 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-900", children: "Salary Management" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 md:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: display.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "td",
        {
          colSpan: isAdmin ? 8 : 7,
          className: "px-4 py-8 text-center text-gray-400",
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            className: "border-t border-gray-50 hover:bg-gray-50",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-blue-600 whitespace-nowrap", children: r.empId }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-gray-800 whitespace-nowrap", children: (emp == null ? void 0 : emp.name) || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-600 whitespace-nowrap", children: (emp == null ? void 0 : emp.jobTitle) || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-gray-700 whitespace-nowrap", children: [
                "RM ",
                r.basicPay.toLocaleString()
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-green-600 whitespace-nowrap", children: [
                "+RM ",
                r.allowances.toLocaleString()
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-red-500 whitespace-nowrap", children: [
                "-RM ",
                r.deductions.toLocaleString()
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 font-bold text-gray-900 whitespace-nowrap", children: [
                "RM ",
      ...
      display.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tfoot", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 font-bold text-blue-700 text-lg whitespace-nowrap", children: [
              "RM ",
    ...
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900", children: editId ? "Edit Salary" : "Add / Edit Salary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: "Employee" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  value: form.empId,
                  ...
                  children: [
                    ...
                    employees.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: e.empId, children: [
                      e.empId,
                      " - ",
                      e.name
                    ] }, e.empId))
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 rounded-lg px-3 py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Net Pay: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-blue-700", children: [
                "RM",
                " ",
                ((Number.parseFloat(form.basicPay) || 0) + (Number.parseFloat(form.allowances) || 0) - (Number.parseFloat(form.deductions) || 0)).toLocaleString()
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 mt-5", children: [
    ...
    deleteConfirm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900 mb-2", children: "Delete Salary Record" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mb-5", children: "Are you sure you want to delete this salary record? This cannot be undone." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        path: "/dashboard",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/employees",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Employees, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/attendance",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Attendance, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/salary",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Salary, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/contracts",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Contracts, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/profit-loss",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfitLoss, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/analysis",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Analysis, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        ...
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Protected, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChangeSecretKey, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/login", replace: true }) })
  ] }) });
...
const ContractType = Variant({
  "in": Record$1({ "client": Text }),
  "out": Record$1({ "vendor": Text })
});
const Time = Int;
const ContractStatus = Variant({
  "active": Null,
  "cancelled": Null,
  "completed": Null
});
const Department = Variant({
  "hr": Null,
  "finance": Null,
  "marketing": Null,
  "sales": Null,
...
const UserProfile = Record$1({
  "name": Text,
  "employeeId": Opt(Nat)
});
const Contract = Record$1({
  "id": Nat,
  "title": Text,
  "endDate": Time,
  "value": Float64,
...
const ExpenseEntry = Record$1({
  "date": Time,
  "description": Text,
  "category": Text,
  "amount": Float64
});
const IncomeEntry = Record$1({
  "date": Time,
  "description": Text,
  "category": Text,
  "amount": Float64
...
Service({
  ...
  "addContract": Func(
    [Text, ContractType, Float64, Time, Time, ContractStatus],
    [Nat],
    []
  ),
  "addEmployee": Func([Text, Department], [Nat], []),
  "addExpense": Func(
    [Time, Text, Text, Float64],
    [Nat],
    []
  ),
  "addIncome": Func(
  ...
  "getContract": Func([Nat], [Contract], ["query"]),
  "getContractByTitle": Func([Text], [Vec(Record)], ["query"]),
  "getEmployee": Func([Nat], [Employee], ["query"]),
  "getExpense": Func([Nat], [ExpenseEntry], ["query"]),
  "getIncome": Func([Nat], [IncomeEntry], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ...
  "linkEmployeeToPrincipal": Func([Nat, Principal2], [], []),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "searchContractByTitle": Func([Text], [Vec(Record)], ["query"])
});
