...
function Analysis() {
  ...
  const attendanceByMonth = MONTHS.map((_, mi) => {
    const m = mi + 1;
    const daysInMonth = new Date(currentYear2, m, 0).getDate();
    const totalSlots = employees.length * daysInMonth;
    const presentCount = Object.entries(attendance).filter(([k, v]) => {
      const parts = k.split("-");
      return Number.parseInt(parts[0]) === currentYear2 && Number.parseInt(parts[1]) === m && v === "P";
    }).length;
    return totalSlots > 0 ? Math.round(presentCount / totalSlots * 100) : 0;
  });
  const salaryByMonth = MONTHS.map((_, mi) => {
    const m = mi + 1;
    return salary.filter((s) => s.month === m && s.year === currentYear2).reduce((sum, s) => sum + s.netPay, 0);
  });
  ...
  const plByMonth = MONTHS.map((_, mi) => {
    ...
    const income = pl.income.filter((i) => {
      ...
      return d.getMonth() + 1 === m && d.getFullYear() === currentYear2;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 mb-4", children: "Monthly Payroll (RM)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 shadow-sm border border-gray-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 mb-4", children: "Key Insights" }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: "Add Contract" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: displayEmps.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "tr",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 capitalize text-gray-600", children: emp.department }),
            ...
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
    ...
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900", children: "Add New Employee" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-gray-500 uppercase", children: "Department" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  ...
                  children: DEPARTMENTS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: d, className: "capitalize", children: d }, d))
                }
              )
            ] })
          ] }),
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl", children: [
          ...
          !adminExists && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm text-gray-500 mt-4", children: [
            "First time?",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
...
function ProfitLoss() {
  ...
  function save() {
    ...
    const updated = entryType === "income" ? { ...data, income: [...data.income, entry] } : { ...data, expenses: [...data.expenses, entry] };
  ...
  function EntryTable({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex-1 min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#F4F6F9" }, children: ["Date", "Category", "Description", "Amount (RM)"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "th",
          {
            className: "px-4 py-2 text-left text-xs font-semibold text-gray-500 uppercase whitespace-nowrap",
            children: h
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(EntryTable, { entries: incomeFiltered, title: "Income", color: "#16A34A" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EntryTable,
          {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold", children: "GP INDUSTRIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm mt-1", children: "Admin Setup - First Time Registration" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-800 font-bold text-xl mb-1", children: "Create Admin Account" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-6", children: "Set up the administrator account to manage GP Industries" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
            ["name", "username", "password", "confirm"].map((field) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "block text-sm font-medium text-gray-700 mb-1 capitalize", children: field === "confirm" ? "Confirm Password" : field === "name" ? "Full Name" : field.charAt(0).toUpperCase() + field.slice(1) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-gray-900", children: "Add / Edit Salary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
